    ...
    <div className="container mx-auto px-4 py-12">
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          <ShoppingBag className="w-8 h-8 text-[#00ffc6]" />
          <h1 className="text-4xl font-bold text-white">Orders Dashboard</h1>
        </div>
        <p className="text-[#c6fff0]">Track all orders across payment methods</p>
      </motion.div>
      ...
      <Card className="glass-card border-[#00ffc6]/20">
        <CardContent className="p-12 text-center">
          ...
          <p className="text-[#bfeee0] mb-4">
            The admin orders dashboard functionality has been removed.
          </p>
